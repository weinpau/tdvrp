...
public class PeriodicalTDFunctionFactoryTest {
    ...
    public void testCreateTDFunction_Constant() {
        ...
        assertEquals(sqrt(200), tdFunction.travelTime(sampleInstance.getDepot(), customer, 0), 0.001);
    ...
    public void testCreateTDFunction_Constant_0() {
        ...
        assertEquals(0, tdFunction.travelTime(customer, customer, 0), 0.001);
    ...
    public void testCreateTDFunction_Overlap() {
        ...
        assertEquals(5 + (sqrt(200) - 5) / 2, tdFunction.travelTime(sampleInstance.getDepot(), customer, 0), 0.001);
